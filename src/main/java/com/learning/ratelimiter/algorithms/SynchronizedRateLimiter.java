...
public class SynchronizedRateLimiter implements RateLimiter {
    ...
    public SynchronizedRateLimiter(int maxRequests, long timeWindowMillis, TimeProvider timeProvider) {
        this.maxRequests = maxRequests;
        this.timeWindowMillis = timeWindowMillis;
        this.timeProvider = timeProvider;
    }
    public SynchronizedRateLimiter(int maxRequests, long timeWindowMillis) {
